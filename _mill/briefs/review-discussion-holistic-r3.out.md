...
### [BLOCKING:consistency] Q&A log still says the skill is copied into the scratch dir
...
### [BLOCKING:consistency] "no dispatch of any kind" vs a mandated `claude` launch
...
### [BLOCKING:scope] Testing plan omits three in-scope units the Python suite covers
...
### [BLOCKING:consistency] `none` scratch-dir "only" list omits the scorer definition
