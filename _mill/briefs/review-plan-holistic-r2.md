...
You are an independent plan reviewer for **Batch-answer contract: per-target coverage + fail-closed Status helpers**.
...
Every unprefixed path below is relative to `/home/knatte/Code/quarry/wts/batch-answer-contract`.
- `wiki/` paths are relative to `/home/knatte/Code/quarry/wiki`

## Files included (N=24)

- _mill/plan/00-overview.md
- _mill/plan/01-engine-vocabulary.md
- _mill/plan/02-coverage-verifiers.md
- _mill/plan/03-consumers-and-docs.md
...
Write your full report to this file: /home/knatte/Code/quarry/wts/batch-answer-contract/_mill/briefs/review-plan-holistic-r2.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/quarry/wts/batch-answer-contract/_mill/briefs/review-plan-holistic-r2.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/quarry/wts/batch-answer-contract/_mill/briefs/review-plan-holistic-r2.out.md`
