...
### [BLOCKING:consistency] Spike section contradicts the grammar-set decision
...
### [BLOCKING:scope] Stale-doc inventory is incomplete, not "four"
...
### [BLOCKING:consistency] `buildOptions` cited as a multi-line signature; it is not
