...
You are an independent code reviewer for **M4 matrix run: execute the descoped kick-start batch (cards 29-32)**.
...
- "self-referential" framing undersells two decision misses as harmless by construction: **Location:** `bench/loomyard-eval/ladder/results/2026-09-06-kickstart/conclusion.md:196-201`
...
Every unprefixed path below is relative to `/home/knatte/Code/quarry/wts/kickstart-matrix-run`.
- `wiki/` paths are relative to `/home/knatte/Code/quarry/wiki`

## Files included (N=27)

- _mill/plan/00-overview.md
- _mill/plan/01-matrix-and-writeup.md
...
Write your full report to this file: /home/knatte/Code/quarry/wts/kickstart-matrix-run/_mill/briefs/review-code-holistic-r2.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/quarry/wts/kickstart-matrix-run/_mill/briefs/review-code-holistic-r2.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/quarry/wts/kickstart-matrix-run/_mill/briefs/review-code-holistic-r2.out.md`
