...
### [BLOCKING:consistency] Ignore set never covers descended directories
...
### [BLOCKING:consistency] `Symbol.File` has no producer in T3
...
### [BLOCKING:consistency] D5's `const`/`var` `Start` contradicts §4's doc-inclusive start
