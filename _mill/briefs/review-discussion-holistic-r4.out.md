...
### [BLOCKING:scope] `docs/glyph.md` §6's Go API list is not in the edit inventory
**Section:** D15 (§6) / D20
...
### [BLOCKING:scope] D7's "four paragraphs become false" undercounts `internal/cli`
**Section:** D7 / D19
...
### [BLOCKING:consistency] Two `glyph/` doc comments misplaced or unlisted
