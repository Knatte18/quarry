...
You are an independent plan reviewer for **Kick-start pack bench: pre-resolved glyph spans in the prompt (M4)**.
...
Every unprefixed path below is relative to `/home/knatte/Code/quarry/wts/ladder-kickstart`.
- `wiki/` paths are relative to `/home/knatte/Code/quarry/wiki`

## Files included (N=46)

- _mill/plan/00-overview.md
- _mill/plan/01-config-surface.md
- _mill/plan/02-control-sweep-and-card.md
- _mill/plan/03-provenance.md
- _mill/plan/04-pack-generation.md
- _mill/plan/05-run-gate-and-subcommand.md
- _mill/plan/06-benchmark-content.md
- _mill/plan/07-matrix-and-writeup.md
...
Write your full report to this file: /home/knatte/Code/quarry/wts/ladder-kickstart/_mill/briefs/review-plan-holistic-r3.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/quarry/wts/ladder-kickstart/_mill/briefs/review-plan-holistic-r3.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/quarry/wts/ladder-kickstart/_mill/briefs/review-plan-holistic-r3.out.md`
