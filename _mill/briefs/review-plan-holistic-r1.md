...
You are an independent plan reviewer for **P3 — the glyphs verb: the planner flat index as a frozen toc preset (roadmap 2a)**.
...
Every unprefixed path below is relative to `/home/knatte/Code/quarry/wts/glyphs-verb`.
- `wiki/` paths are relative to `/home/knatte/Code/quarry/wiki`

## Files included (N=33)

- _mill/plan/00-overview.md
- _mill/plan/01-facade-glyphs-view.md
- _mill/plan/02-cli-view-flag-and-glyphs-verb.md
- _mill/plan/03-goldens-and-docs.md
- quarry/repo.go
- quarry/doc.go
...
Write your full report to this file: /home/knatte/Code/quarry/wts/glyphs-verb/_mill/briefs/review-plan-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/quarry/wts/glyphs-verb/_mill/briefs/review-plan-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/quarry/wts/glyphs-verb/_mill/briefs/review-plan-holistic-r1.out.md`
