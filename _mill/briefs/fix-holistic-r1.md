# Holistic Fixer Brief — Glyph self-form and the resolve contract (C1)
...
- **Holistic review file:** `/home/knatte/Code/quarry/wts/glyph-self-form/_mill/reviews/20260905-125620-code-review-r1.md`
- **Plan overview:** `/home/knatte/Code/quarry/wts/glyph-self-form/_mill/plan/00-overview.md`
- **Worktree cwd (use for git and verify):** `/home/knatte/Code/quarry/wts/glyph-self-form`
...
```
/home/knatte/Code/quarry/wts/glyph-self-form/_mill/plan/01-glyph-grammar.md
/home/knatte/Code/quarry/wts/glyph-self-form/_mill/plan/02-engine-resolve-contract.md
/home/knatte/Code/quarry/wts/glyph-self-form/_mill/plan/03-expand-gate-and-sentinel.md
/home/knatte/Code/quarry/wts/glyph-self-form/_mill/plan/04-cli-repopath-mcp.md
/home/knatte/Code/quarry/wts/glyph-self-form/_mill/plan/05-docs-and-goldens.md
```

## Before reading any finding

Load the **mill-receiving-review** skill before reading any finding in `/home/knatte/Code/quarry/wts/glyph-self-form/_mill/reviews/20260905-125620-code-review-r1.md`.
...
Run each from `/home/knatte/Code/quarry/wts/glyph-self-form` via Bash.
...
**Pre-report self-check (mandatory before emitting success JSON):** At the very start of your session (before any edit), record `git -C /home/knatte/Code/quarry/wts/glyph-self-form rev-parse HEAD` as your baseline -- this is the holistic fix housekeeping commit (message starts with `mill-go: holistic fix`).
Before reporting `success`, confirm HEAD now differs from that recorded baseline;
never report `success` when HEAD equals the baseline (no new commit was made), unless every finding was a legitimate --nits-only no-op requiring no code change. Run `git -C /home/knatte/Code/quarry/wts/glyph-self-form status --porcelain --untracked-files=no`.
...
```json
{"status":"success","commit_sha":"<last-HEAD-sha>","session_id":"fa5e6cb9-c02c-4fe1-b496-f7a7f32c2b46"}
```
**Do not wrap the JSON in a code block.
Output it as a bare line — no backticks, no fence.
Anything other than a bare JSON line is treated as `stuck_type: logic`.**

**`session_id` MUST be exactly `fa5e6cb9-c02c-4fe1-b496-f7a7f32c2b46` (the UUID shown in the example above — it was injected into this brief when it was rendered).
Copy it verbatim.**
...
```json
{"status":"stuck","stuck_type":"transient|verify|logic","reason":"<one-line>","commit_sha":"<last-HEAD-sha>","session_id":"fa5e6cb9-c02c-4fe1-b496-f7a7f32c2b46"}
```
**Do not wrap the JSON in a code block.
Output it as a bare line — no backticks, no fence.
Anything other than a bare JSON line is treated as `stuck_type: logic`.**
