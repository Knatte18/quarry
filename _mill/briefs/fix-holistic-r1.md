# Holistic Fixer Brief — Kick-start pack bench: pre-resolved glyph spans in the prompt (M4)
...
- **Holistic review file:** `/home/knatte/Code/quarry/wts/ladder-kickstart/_mill/reviews/20260905-130128-code-review-r1.md`
- **Plan overview:** `/home/knatte/Code/quarry/wts/ladder-kickstart/_mill/plan/00-overview.md`
- **Worktree cwd (use for git and verify):** `/home/knatte/Code/quarry/wts/ladder-kickstart`
...
```
/home/knatte/Code/quarry/wts/ladder-kickstart/_mill/plan/01-config-surface.md
/home/knatte/Code/quarry/wts/ladder-kickstart/_mill/plan/02-control-sweep-and-card.md
/home/knatte/Code/quarry/wts/ladder-kickstart/_mill/plan/03-provenance.md
/home/knatte/Code/quarry/wts/ladder-kickstart/_mill/plan/04-pack-generation.md
/home/knatte/Code/quarry/wts/ladder-kickstart/_mill/plan/05-run-gate-and-subcommand.md
/home/knatte/Code/quarry/wts/ladder-kickstart/_mill/plan/06-benchmark-content.md
```

## Before reading any finding

Load the **mill-receiving-review** skill before reading any finding in `/home/knatte/Code/quarry/wts/ladder-kickstart/_mill/reviews/20260905-130128-code-review-r1.md`.
...
Run each from `/home/knatte/Code/quarry/wts/ladder-kickstart` via Bash.
...
**Pre-report self-check (mandatory before emitting success JSON):** At the very start of your session (before any edit), record `git -C /home/knatte/Code/quarry/wts/ladder-kickstart rev-parse HEAD` as your baseline -- this is the holistic fix housekeeping commit (message starts with `mill-go: holistic fix`).
Before reporting `success`, confirm HEAD now differs from that recorded baseline;
never report `success` when HEAD equals the baseline (no new commit was made). Run `git -C /home/knatte/Code/quarry/wts/ladder-kickstart status --porcelain --untracked-files=no`.
...
```json
{"status":"success","commit_sha":"<last-HEAD-sha>","session_id":"8d54d171-dc69-4d3f-9a3f-d9efe9c3aea6"}
```
**Do not wrap the JSON in a code block.
Output it as a bare line — no backticks, no fence.
Anything other than a bare JSON line is treated as `stuck_type: logic`.**

**`session_id` MUST be exactly `8d54d171-dc69-4d3f-9a3f-d9efe9c3aea6` (the UUID shown in the example above — it was injected into this brief when it was rendered).
Copy it verbatim.**
...
```json
{"status":"stuck","stuck_type":"transient|verify|logic","reason":"<one-line>","commit_sha":"<last-HEAD-sha>","session_id":"8d54d171-dc69-4d3f-9a3f-d9efe9c3aea6"}
```
**Do not wrap the JSON in a code block.
Output it as a bare line — no backticks, no fence.
Anything other than a bare JSON line is treated as `stuck_type: logic`.**
