...
### [BLOCKING:decision] `within`-filter helpers have no disposition
...
### [BLOCKING:consistency] CLI batch-parity claim is inverted
...
### [BLOCKING:consistency] toc path semantics contradict the output rule
