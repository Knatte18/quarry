...
### [BLOCKING:consistency] Repo-tracked skill unreachable from scratch-dir cwd
...
### [BLOCKING:consistency] `none` arm's `.mcp.json` contradicts a committed invariant
...
### [BLOCKING:consistency] Session count 18 conflicts with the 15-config / 45-run arithmetic
...
### [BLOCKING:scope] Retry/`MAX_ATTEMPTS` bookkeeping has no owner
