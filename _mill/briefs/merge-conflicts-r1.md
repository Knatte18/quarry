...
Stage the deletion with `git -C /home/knatte/Code/quarry/wts/glyphs-verb rm <file>`.
...
### From _mill/plan/01-facade-glyphs-view.md
...
### From _mill/plan/02-cli-view-flag-and-glyphs-verb.md
...
### From _mill/plan/03-goldens-and-docs.md
...
5. Run `git -C /home/knatte/Code/quarry/wts/glyphs-verb add <file>` to stage the resolved file.
6. For modify/delete (DU) conflicts: if Task intent above lists this file under a batch's `Deletes:`, run `git -C /home/knatte/Code/quarry/wts/glyphs-verb rm <file>` instead of editing;
...
Use `git -C /home/knatte/Code/quarry/wts/glyphs-verb` for any git commands;
do not `cd`.
Worktree cwd is `/home/knatte/Code/quarry/wts/glyphs-verb`.
