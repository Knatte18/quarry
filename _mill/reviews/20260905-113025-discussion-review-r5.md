...
### [NIT:consistency] D10a's `Unit` reversal not propagated to D14/Testing/Q&A
...
### [NIT:scope] D7's falsified-paragraph inventory is wrong in count and in location
**Demoted-from:** BLOCKING
...
### [NIT:scope] `glyph/` doc-comment inventory omits two falsified statements
**Demoted-from:** BLOCKING
