...
### [NIT:consistency] Deferred `none` scoring breaks single-flight
...
### [NIT:consistency] `{n}` rule does not cover per-rep `none` sessions
**Demoted-from:** BLOCKING
...
### [NIT:decision] `none` scoring session has no stated provisioning
**Demoted-from:** BLOCKING
...
### [NIT:consistency] Q&A log carries unmarked superseded entries
**Demoted-from:** BLOCKING
**Section:** §Q&A log
