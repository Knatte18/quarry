...
### [NIT:decision] `TOC`'s target-error contract is undefined
...
### [NIT:decision] `ErrLanguageUnsupported` has no stated disposition
**Demoted-from:** BLOCKING
...
### [NIT:decision] `toc_integration_test.go` is absent from the ported-test list
**Demoted-from:** BLOCKING
...
### [NIT:consistency] D15 caches the ignore set; Constraints forbid caching
**Demoted-from:** BLOCKING
