...
### [NIT:consistency] Provenance and Technical context contradict on batch 5
...
### [NIT:scope] The first of Scope's "two permitted exceptions" is never defined
**Demoted-from:** BLOCKING
...
### [NIT:scope] D17's fixture inventory does not cover the Testing section
**Demoted-from:** BLOCKING
