...
### [NIT:consistency] Resume contradicts `build_worktree`'s existence check
...
### [NIT:consistency] `summary.json` promises fields its loader never reads
**Demoted-from:** BLOCKING
...
_Note: 2 finding(s) demoted from BLOCKING to NIT by the stage's blocking-class ceiling; current blocking_count is 7._
MILL_REVIEW_END
