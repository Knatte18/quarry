...
### [NIT:consistency] CLI is told to import an engine subpackage directly
...
_Note: 1 finding(s) demoted from BLOCKING to NIT by the stage's blocking-class ceiling; current blocking_count is 5._
MILL_REVIEW_END
