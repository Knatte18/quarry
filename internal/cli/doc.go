...
// symbol-table difference between the two versions of that target the two revisions name.
//
...
// remote URL against a local directory would. "toc" and "delta" are the two verbs that still take
// a path, and they are the two verbs this package still converts with internal/repopath before the
