// target.go declares repoRelTarget, the CLI's own path arithmetic that converts a caller-supplied
// target into a clean, forward-slash, repository-relative path before the engine ever sees it.
...
// repoRelTarget converts target, as given on the command line, into a clean, forward-slash,
